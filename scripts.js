...
header.innerHTML=`<div class="flex justify-between h-[28px] w-full mb-[35px] lg:hidden">
                    ...
                    <div class="lg:hidden">
                    <a href="/#"><img src="${locationDetails["header"][0]["brandlogomobile"]}" alt="brand logo" class="w-[99px] h-[20px]"></a>
                    </div>
                    ...
                    <div>
                        <button class="border-[#C3D4E9] border-[1px] rounded-[10px] p-[10px]" onclick="showleftside()"  aria-label="Filter button">
                    ...
                    <div class="flex">
                        <img src="${locationDetails["header"][0]["brandlogodes"]}" alt="brand logo" class="brandogodes w-[133px] mb-[7px] max-w-none mt-[7px]">
                    </div>
